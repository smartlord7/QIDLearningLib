...
def l_diversity(df: pd.DataFrame, quasi_identifiers: Iterable[str], sensitive_attributes: Iterable[str]) -> GroupedMetric:
    """
...
def closeness_centrality(df: pd.DataFrame, quasi_identifiers: Iterable[str], sensitive_attributes: Iterable[str]) -> GroupedMetric:
    """
...
def t_closeness(df: pd.DataFrame, quasi_identifiers: Iterable[str], sensitive_attributes: Iterable[str]) -> GroupedMetric:
    """
...
def generalization_ratio(df: pd.DataFrame, quasi_identifiers: Iterable[str], sensitive_attributes: Iterable[str]) -> GroupedMetric:
    """
...
def reciprocal_rank(df: pd.DataFrame, quasi_identifiers: Iterable[str], sensitive_attributes: Iterable[str]) -> GroupedMetric:
    """
