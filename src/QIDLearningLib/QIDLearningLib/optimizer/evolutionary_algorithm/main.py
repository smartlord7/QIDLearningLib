...
# Import QID-specific metric functions and supporting classes
...
def process():
    ...
    # -----------------------------
    metrics = [
        Metric("Distinction", 5, compute_distinction, maximize=True),
        Metric("Separation", 0.5, compute_separation, maximize=True),
        Metric("k-Anonymity", -0.4, compute_k_anonymity, maximize=True),
        Metric("Delta Distinction", 0.2, compute_delta_distinction, maximize=True),
        Metric("Delta Separation", 0.2, compute_delta_separation, maximize=True),
        Metric("Attribute Length Penalty", -1, compute_attribute_length_penalty, maximize=True)
    ]
